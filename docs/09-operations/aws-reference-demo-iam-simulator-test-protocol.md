...
| SIM-098 | Express Infrastructure Role / Permissions Boundary | `ec2:CreateTags` auf synthetische Security Group und Security-Group-Rule | breite Identity-Policy; nicht freigegebener `ec2:CreateAction=CreateNetworkInterface`; keine fehlenden Kontextwerte | `implicitDeny` × 2 | bestanden |
...
SIM-121  CFN_SERVICE_ROLE_EC2_READS_STATIC_DOCUMENTS=4
         CFN_SERVICE_ROLE_EC2_READS_STATIC_ACTIONS=9
         CFN_SERVICE_ROLE_EC2_READS_STATIC_ACTION_DOCUMENT_PAIRS=18
         CFN_SERVICE_ROLE_EC2_READS_STATIC_FOUNDATION_RESOURCES=9
         CFN_SERVICE_ROLE_EC2_READS_STATIC_BOUNDARY_RESOURCES=9
         CFN_SERVICE_ROLE_EC2_READS_STATIC_CONDITIONED_STATEMENTS=18
         CFN_SERVICE_ROLE_EC2_READS_STATIC_ACTION_WILDCARDS=0
         CFN_SERVICE_ROLE_EC2_READS_STATIC_CHECK=passed
         CFN_SERVICE_ROLE_EC2_READS=allowed × 9
         CFN_SERVICE_ROLE_EC2_READS_TOTAL=9
         CFN_SERVICE_ROLE_EC2_READS_RESOURCE_SPECIFIC_RESULTS=0
         CFN_SERVICE_ROLE_EC2_READS_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_EC2_READS_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_EC2_READS_MATCHED_STATEMENTS=9
         CFN_SERVICE_ROLE_EC2_READS_BOUNDARY_ALLOWED=9
         CFN_SERVICE_ROLE_EC2_READS_TRUNCATED=false
         CFN_SERVICE_ROLE_EC2_READS_POSITIVE=passed
SIM-122  CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION=implicitDeny × 9
         CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION_TOTAL=9
         CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION_RESOURCE_SPECIFIC_RESULTS=0
         CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_EC2_READS_WRONG_REGION_MATCHED_STATEMENTS=0
...
SIM-131  CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_DOCUMENTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_UNIQUE_ACTIONS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_IDENTITY_ACTION_OCCURRENCES=5
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_BOUNDARY_ACTION_OCCURRENCES=5
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_ACTION_DOCUMENT_PAIRS=8
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_SERVICE_STATEMENT_ACTIONS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_SERVICE_STATEMENT_RESOURCES=2
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_BOUNDARY_ECS_STATEMENT_ACTIONS=10
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_BOUNDARY_ECS_STATEMENT_RESOURCES=3
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_BOUNDARY_SECRET_STATEMENT_ACTIONS=6
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_BOUNDARY_SECRET_STATEMENT_RESOURCES=1
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_CONDITIONED_STATEMENTS=1
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_REQUEST_TAGS=5
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_ALLOWED_TAG_KEYS=5
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_ACTION_WILDCARDS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_STATIC_CHECK=passed
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES=allowed × 4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_TOTAL=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_MATCHED_STATEMENTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BOUNDARY_ALLOWED=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_POSITIVE=passed
SIM-132  CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY=implicitDeny × 4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_TOTAL=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_BOUNDARY_ALLOWED=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_BAD_TAG_KEY_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT=implicitDeny × 4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_TOTAL=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_BOUNDARY_ALLOWED=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_PROJECT_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION=implicitDeny × 4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_TOTAL=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_BOUNDARY_ALLOWED=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_WRONG_REGION_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE=implicitDeny × 4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_TOTAL=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_FOREIGN_RESOURCE_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_NEGATIVE_TOTAL=16
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_NEGATIVE_RESOURCE_SPECIFIC_RESULTS=16
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_NEGATIVE_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_NEGATIVE_BOUNDARY_ALLOWED=12
         CFN_SERVICE_ROLE_ECS_SECRET_CREATES_NEGATIVE=passed
SIM-133  CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_DOCUMENTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_UNIQUE_ACTIONS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_IDENTITY_ACTION_OCCURRENCES=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_BOUNDARY_ACTION_OCCURRENCES=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_ACTION_DOCUMENT_PAIRS=8
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_SERVICE_STATEMENT_ACTIONS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_SERVICE_STATEMENT_RESOURCES=1
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_BOUNDARY_SECRET_STATEMENT_ACTIONS=6
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_BOUNDARY_SECRET_STATEMENT_RESOURCES=1
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_CONDITIONED_STATEMENTS=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_ACTION_WILDCARDS=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_STATIC_CHECK=passed
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE=allowed allowed allowed allowed
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_TOTAL=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_MATCHED_STATEMENTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_BOUNDARY_ALLOWED=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_TRUNCATED=false
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_POSITIVE=passed
SIM-134  CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET=implicitDeny implicitDeny implicitDeny implicitDeny
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_TOTAL=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:RequestedRegion|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_TRUNCATED=false
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_SECRET_NEGATIVE=passed
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION=implicitDeny implicitDeny implicitDeny implicitDeny
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_TOTAL=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:RequestedRegion|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_TRUNCATED=false
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_WRONG_REGION_NEGATIVE=passed
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT=implicitDeny implicitDeny implicitDeny implicitDeny
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_TOTAL=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_RESOURCE_SPECIFIC_RESULTS=4
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:RequestedRegion|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_TRUNCATED=false
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_FOREIGN_ACCOUNT_NEGATIVE=passed
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_NEGATIVE_TOTAL=12
         CFN_SERVICE_ROLE_SECRET_LIFECYCLE_NEGATIVE_RESOURCE_SPECIFIC_RESULTS=12
...
SIM-137  CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_DOCUMENTS=4
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_UNIQUE_ACTIONS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_IDENTITY_ACTION_OCCURRENCES=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_BOUNDARY_ACTION_OCCURRENCES=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_ACTION_DOCUMENT_PAIRS=2
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_CONDITIONED_STATEMENTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_SERVICE_EXACT_STATEMENTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_BOUNDARY_EXACT_STATEMENTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_ACTION_WILDCARDS=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_STATIC_CHECK=passed
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE=allowed
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_TOTAL=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_RESOURCE_SPECIFIC_RESULTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_MATCHED_STATEMENTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_BOUNDARY_ALLOWED=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_POSITIVE=passed
SIM-138  CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION=implicitDeny
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_TOTAL=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_RESOURCE_SPECIFIC_RESULTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_BOUNDARY_ALLOWED=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_REGION_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER=implicitDeny
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_TOTAL=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_RESOURCE_SPECIFIC_RESULTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_WRONG_CLUSTER_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT=implicitDeny
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_TOTAL=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_RESOURCE_SPECIFIC_RESULTS=1
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_MISSING_CONTEXT=aws:RequestTag/Component|aws:RequestTag/Environment|aws:RequestTag/Lifecycle|aws:RequestTag/ManagedBy|aws:RequestTag/Project|aws:TagKeys|ec2:CreateAction|ec2:ResourceTag/Project|ecs:ResourceTag/Project|iam:PassedToService|iam:PermissionsBoundary|iam:PolicyARN|iam:ResourceTag/Project|secretsmanager:ForceDeleteWithoutRecovery
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_RELEVANT_MISSING_CONTEXT=none
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_MATCHED_STATEMENTS=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_BOUNDARY_ALLOWED=0
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_TRUNCATED=false
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_FOREIGN_ACCOUNT_NEGATIVE=passed
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_NEGATIVE_TOTAL=3
         CFN_SERVICE_ROLE_ECS_CLUSTER_CREATE_NEGATIVE_RESOURCE_SPECIFIC_RESULTS=3
...
SIM-131 bestätigt anschließend die vier Create-/Tag-Aktionen des gemeinsamen
ECS-/Secrets-Manager-Statements auf den jeweiligen Referenzressourcen. Alle
vier Gesamt- und Ressourcenentscheidungen sind mit den fünf festen Request-
Tags, exakt fünf zulässigen Tag-Schlüsseln und der richtigen Region `allowed`.
Es fehlte kein Kontextwert, vier Statements trafen zu, die Boundary gab alle
vier Ressourcen frei und kein Ergebnis war trunkiert. Die fünf statischen
Action-Vorkommen je Policy-Pfad sind erwartet, weil `ecs:TagResource`
zusätzlich in einem getrennten Task-Definition-Statement vorkommt; simuliert
wurden vier eindeutige Action-/Ressourcenpaare.

SIM-132 bestätigt dieselben vier Aktionen gegen den zusätzlichen Tag-Schlüssel
`Owner`, einen falschen Project-Wert, die falsche Region `eu-west-1` und vier
fremde Ressourcen. Alle 16 Gesamt- und Ressourcenentscheidungen sind
`implicitDeny`; kein Identity-Statement traf zu. Die Boundary blieb bei den
zwölf reinen Condition-Gegenfällen freigebend und verweigerte alle vier
fremden Ressourcen. Die rohen fehlenden Kontextwerte stammen ausschließlich
aus fachlich unbeteiligten Statements; alle sieben für dieses Statement
relevanten Kontextgruppen waren vollständig. Kein Ergebnis war trunkiert.

SIM-133 bestätigt die vier unbedingten Secrets-Manager-Read-/Update-Aktionen
`DescribeSecret`, `GetSecretValue`, `UntagResource` und `UpdateSecret` auf dem
synthetischen Referenz-Secret. Alle vier Gesamt- und Ressourcenentscheidungen
sind `allowed`; es fehlte kein Kontextwert, vier Statements trafen zu, die
Boundary gab alle vier Ressourcen frei und kein Ergebnis war trunkiert.

SIM-134 bestätigt dieselben vier Aktionen gegen ein falsches Secret, das feste
Secret-Namensmuster in `eu-west-1` und dasselbe Namensmuster in einem fremden
Konto. Alle zwölf Gesamt- und Ressourcenentscheidungen sind `implicitDeny`;
kein Identity-Statement traf zu und die Boundary gab keine Ressource frei. Die
rohen fehlenden Kontextwerte stammen ausschließlich aus fachlich
...
SIM-137 bestätigt `ecs:CreateCluster` ausschließlich für den exakten
`cluster/default`-ARN im Referenzkonto mit
`aws:RequestedRegion=eu-central-1`. Die Gesamt- und Ressourcenentscheidung ist
`allowed`; es fehlte kein Kontextwert, genau ein Identity-Statement traf zu,
die Boundary gab die Ressource frei und das Ergebnis war nicht trunkiert. Der
statische Vorcheck bestätigt genau ein Action-Vorkommen in der Service-Policy,
genau eines in der Boundary, genau eine Regionsbedingung und keine
Action-Wildcards.

SIM-138 trennt die beiden Schutzebenen adversarial: Mit weiterhin korrektem
`cluster/default`-ARN, aber `aws:RequestedRegion=eu-west-1`, ist die
Gesamtentscheidung `implicitDeny`; kein Identity-Statement trifft zu, während
die ressourcenbasierte Boundary weiterhin freigibt. Ein falscher Clustername
und derselbe Clustername in einem fremden Konto sind ebenfalls
`implicitDeny`; dort gibt die Boundary nicht frei. Insgesamt ergeben sich drei
Gesamt- und Ressourcenentscheidungen `implicitDeny`, null passende
Identity-Statements und genau eine Boundary-Freigabe. Die rohen fehlenden
Kontextwerte stammen ausschließlich aus fachlich unbeteiligten Statements;
`aws:RequestedRegion` war für alle drei Fälle vollständig. Kein Ergebnis war
trunkiert.

Damit ist der bewusst separat und ohne spekulative Request-Tag-Bedingungen
...
Quelle für SIM-121 und SIM-122: vom Nutzer am 17. August 2026 ausdrücklich
gemeldete Terminalausgaben des vollständig bestandenen Harnesses auf dem
geprüften Ausgangsstand
...
Quelle für SIM-131 und SIM-132: vom Nutzer am 18. August 2026 ausdrücklich
gemeldete Terminalausgaben des vollständig bestandenen Harnesses auf dem
geprüften Ausgangsstand
`02a659340167466189994d8fa1039eb28d2f2d7a`.

Quelle für SIM-133 und SIM-134: vom Nutzer am 18. August 2026 ausdrücklich
gemeldete Terminalausgaben des vollständig bestandenen Harnesses auf dem
geprüften Ausgangsstand
...
Quelle für SIM-137 und SIM-138: vom Nutzer am 18. August 2026 ausdrücklich
gemeldete Terminalausgaben des vollständig bestandenen Harnesses auf dem
geprüften Ausgangsstand
